...
if (!class_exists('DocdirectApp_Core')) {
    ...
    class DocdirectApp_Core {
         ...
         *
         * - DocdirectApp_Loader. Orchestrates the hooks of the plugin.
         * - DocdirectApp_i18n. Defines internationalization functionality.
         * - DocdirectApp_Admin. Defines all hooks for the admin area.
         * - DocdirectApp_Public. Defines all hooks for the public side of the site.
         *
        ...
        private function load_dependencies() {
            ...
            $this->loader = new DocdirectApp_Loader();
        }

        /**
         * Define the locale for this plugin for internationalization.
         *
         * Uses the DocdirectApp_i18n class in order to set the domain and to register the hook
         * with WordPress.
         *
         * @since    1.0.0
         * @access   private
        ...
        private function set_locale() {
            ...
            $plugin_i18n = new DocdirectApp_i18n();
        ...
        private function define_admin_hooks() {
            $plugin_admin = new DocdirectApp_Admin();
        ...
        private function define_public_hooks() {
            ...
            $plugin_public = new DocdirectApp_Public();
         ...
         *
         * @since     1.0.0
         * @return    DocdirectApp_Loader    Orchestrates the hooks of the plugin.
         */
