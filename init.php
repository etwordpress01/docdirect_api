...
//include APP API
$dir = DocdirectAppGlobalSettings::get_plugin_path();
...
function docdirect_app_load_textdomain() {
  load_plugin_textdomain( 'docdirect_api', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' ); 
}
